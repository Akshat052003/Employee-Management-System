...
const AllTasks = () => {
  ...
  return (
    <div className='bg-[#1c1c1c] p-5 mt-5  rounded-md'>
      <div className='bg-red-400 mb-2 px-4 py-2 flex justify-between rounded-md'>
      ...
      {userData.map((elem,index)=> {
        return <div key={index} className='border-2 border-emerald-500 mb-2 px-4 py-2 flex justify-between rounded-md'>
